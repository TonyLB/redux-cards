...
const preloadState = () => { 
    let loadFuncs = [
        ...
        preloadHand,
        preloadDecks,
        preloadTrack(['PlotIntercept1', 'EVAFuel1', 'DeployFracking1', 'UpgradeBussard1', 'UpgradeDrive1', 'UpgradeEVA1', 'AutoDraw'], 'equipmentTrack'),
        preloadTrack(['DesignCargoBay', 'Survey', 'DesignAsteroidBelt', 'DesignFuelTank', 'DesignSensor1'], 'scienceTrack'),
